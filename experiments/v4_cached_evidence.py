...
def write_latex_tables(scorecard: list[dict[str, Any]], protocol: list[dict[str, Any]], rubric: list[dict[str, Any]], attacks: list[dict[str, Any]]) -> None:
    score_lines = [
        ...
        r"\begin{longtable}{>{\raggedright\arraybackslash}p{0.20\linewidth}>{\raggedright\arraybackslash}p{0.09\linewidth}>{\raggedright\arraybackslash}p{0.27\linewidth}>{\raggedright\arraybackslash}p{0.24\linewidth}>{\raggedright\arraybackslash}p{0.12\linewidth}}",
    ...
    protocol_lines = [
        ...
        r"\setlength{\tabcolsep}{3pt}",
        r"\renewcommand{\arraystretch}{1.08}",
        r"\begin{longtable}{>{\raggedright\arraybackslash}p{0.23\linewidth}>{\raggedright\arraybackslash}p{0.10\linewidth}>{\raggedright\arraybackslash}p{0.55\linewidth}}",
    ...
    protocol_lines.extend([r"\bottomrule", r"\end{longtable}", r"\endgroup", ""])
    ...
    rubric_lines = [
        ...
        r"\setlength{\tabcolsep}{3pt}",
        r"\renewcommand{\arraystretch}{1.08}",
        r"\begin{longtable}{>{\raggedright\arraybackslash}p{0.22\linewidth}>{\raggedright\arraybackslash}p{0.10\linewidth}>{\raggedright\arraybackslash}p{0.56\linewidth}}",
    ...
    rubric_lines.extend([r"\bottomrule", r"\end{longtable}", r"\endgroup", ""])
    ...
    attack_lines = [
        ...
        r"\begin{longtable}{>{\raggedright\arraybackslash}p{0.05\linewidth}>{\raggedright\arraybackslash}p{0.14\linewidth}>{\raggedright\arraybackslash}p{0.30\linewidth}>{\raggedright\arraybackslash}p{0.35\linewidth}>{\raggedright\arraybackslash}p{0.06\linewidth}}",
        r"\caption{Full 60-round v4 reviewer attack ledger.}\label{tab:v4-attack-ledger}\\",
        r"\toprule",
