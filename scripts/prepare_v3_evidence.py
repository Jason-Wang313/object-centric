...
def write_latex_tables(scorecard: list[dict], attacks: list[dict]) -> None:
    score_lines = [
        ...
        r"\begin{tabular}{@{}p{0.06\linewidth}p{0.22\linewidth}p{0.12\linewidth}p{0.26\linewidth}p{0.21\linewidth}@{}}",
        r"\toprule",
    ...
    attack_lines = [
        ...
        r"\setlength{\tabcolsep}{2pt}",
        r"\renewcommand{\arraystretch}{1.08}",
        r"\begin{longtable}{@{}p{0.04\linewidth}p{0.12\linewidth}p{0.29\linewidth}p{0.39\linewidth}p{0.05\linewidth}@{}}",
